...
<body>
    ...
    <div class="relative flex flex-col items-center justify-center bg-emerald-950 h-screen">
        ...
        <img class="absolute bottom-10 sm:bottom-5 left-20 md:left-20 sm:left-10 lg:left-40" src="heromenu.png" alt="Hero Menu" width="200" height="200">
        <img style="transform: scale(-1, 1)" class="absolute bottom-10 sm:bottom-5 right-20 md:right-10 lg:right-40 sm:right-20" src="heromenu.png" alt="Hero Menu" width="200" height="200">
    </div>
    ...
    <div class=" bg-white h-full md:py-20 opacity-0 transition-opacity ease-in-out duration-1000 fade-section">
        ...
        <div class="card flex flex-col md:flex-row sm:flex-columns-reverse px-10 py-10">
            ...
            <div class="card-detail px-10 sm:px-0 md:px-10">
                ...
                <div class="middle py-10 md:py-10 text-l">Where Sulawesi meets culinary expertise, fresh ingredients straight from the source. Every bite tells a story of Indonesia's nature.
                    Feel the warmth of Sulawesi's culture in every bite. Only here!    
                    <br><br>
                    <br>Curious to know more about our secret sauce? <br>Explore further on this page.</div>
            </div>
        </div>
    </div>
    ...
    <div class=" bg-emerald-950 h-full md:py-20 opacity-0 transition-opacity ease-in-out duration-1000 fade-section">
        ...
        <div class="card flex flex-col md:flex-row px-10 py-10">
            <div class="card-detail text-white px-10 md:px-10 sm:px-0">
                <div class="top font-eb-garamond text-7xl py-10 md:py-0">Appetite<br>Suppressant.</div>
                <div class="middle pt-10 md:py-10 text-l">
                    ...
                    <br><br>
                    Rest assured, your trust and satisfaction are our top priorities.</div>
            ...
            <img class=" flex justify-center rounded-lg max-h-100" src="sate.png" alt="About Us" height="300" width="700">
        ...
        <div class="group saturate-0 hover:saturate-100 swiper swiper-container">
            <div class="swiper-wrapper py-5">
                <div class="swiper-slide">
                    <div class="flex space-x-16 md:space-x-16 sm:space-x-0 items-center justify-center">
                        <img class="w-[220px] h-[220px]" src="fav1.png" />
                        <img class="w-[220px] h-[220px]" src="fav2.png" />
                        <img class="w-[220px] h-[220px]" src="fav3.png" />
                        <img class="w-[220px] h-[220px]" src="fav4.png" />
                        <img class="w-[220px] h-[220px]" src="fav5.png" />
                    </div>
                </div>
                <div class="swiper-slide ">
                    <div class="flex space-x-16 md:space-x-16 sm:space-x-0 items-center justify-center">
    ...
    <div id="maps" class=" flex bg-yellow-100 h-screen">
        ...
        <!-- <iframe class="absolute top-0 left-0 w-full h-full"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15955.266709937522!2d104.040160!3d1.113169!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d98b0626892bb1%3A0x3d2f00314632707e!2sBatam%2C%20Kepulauan%20Riau%2C%20Indonesia!5e0!3m2!1sen!2sus!4v1648482801994!5m2!1sen!2sus"
